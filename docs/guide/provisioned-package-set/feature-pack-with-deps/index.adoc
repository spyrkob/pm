...
Feature pack may depend on one or more other feature-packs. Feature-pack dependencies are expressed in the feature-pack's metadata, i.e. *feature-pack.xml* file. For example:
