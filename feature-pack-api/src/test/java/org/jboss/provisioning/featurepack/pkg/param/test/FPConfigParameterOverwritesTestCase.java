 ...
 */
public class FPConfigParameterOverwritesTestCase extends PmProvisionConfigTestBase {
    ...
    protected void setupRepo(FeaturePackRepoManager repoManager) throws ProvisioningDescriptionException {
        ...
        .newFeaturePack(fp1Gav)
            ...
            .addDependency("fp3dep", FeaturePackConfig.builder(fp3Gav)
                    .includePackage(PackageConfig.builder("fp3.a")
                            .addParameter("param.fp3.a1", "param.fp3.a1.fp1")
                            .addParameter("param.fp3.a2", "param.fp3.a2.fp1")
                            .build())
                    .build())
            .newPackage("fp1.a", true)
                 .addDependency("fp3dep", PackageDependencySpec.builder("fp3.a")
                        .addParameter("param.fp3.a5", "param.fp3.a6.fp1.a")
                        .addParameter("param.fp3.a6", "param.fp3.a6.fp1.a")
                        .build())
                .getFeaturePack()
            .getInstaller()
        .newFeaturePack(fp2Gav)
            .addDependency(FeaturePackConfig.builder(fp3Gav)
                    .includePackage(PackageConfig.builder("fp3.a")
                            ...
                            .addParameter("param.fp3.a3", "param.fp3.a3.fp2")
                            .build())
                    .build())
            .getInstaller()
        .newFeaturePack(fp3Gav)
            .newPackage("fp3.a", true)
                ...
                .addParameter("param.fp3.a4", "param.fp3.a4.a")
                .addParameter("param.fp3.a5", "param.fp3.a5.a")
                .addParameter("param.fp3.a6", "param.fp3.a6.a")
                .addParameter("param.fp3.a7", "param.fp3.a7.a")
                .getFeaturePack()
            .getInstaller()
        .install();
    }
    ...
    protected ProvisioningConfig provisioningConfig() throws ProvisioningDescriptionException {
        return ProvisioningConfig.builder()
                ...
                .addFeaturePack(FeaturePackConfig.builder(fp3Gav)
                        .includePackage(PackageConfig.builder("fp3.a")
                                .addParameter("param.fp3.a1", "param.fp3.a1.user")
                                .addParameter("param.fp3.a5", "param.fp3.a5.user")
                                .build())
                        .build())
                .build();
    }
