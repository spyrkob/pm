 ...
 */
@Ignore
public class ConfigInheritedFromFeaturePackTestCase extends PmInstallFeaturePackTestBase {

    private final Gav fp1Gav = ArtifactCoords.newGav("org.jboss.pm.test", "fp1", "1.0.0.Beta1");
    private final Gav fp2Gav = ArtifactCoords.newGav("org.jboss.pm.test", "fp2", "1.0.0.Beta1");
    ...
    protected void setupRepo(FeaturePackRepoManager repoManager) throws ProvisioningDescriptionException {
        ...
        .newFeaturePack(fp2Gav)
            .addDependency("fp1", FeaturePackConfig.builder(fp1Gav, false)
                    .includePackage("a")
                    .build())
            .getInstaller()
        .install();
    ...
    protected FeaturePackConfig featurePackConfig() throws ProvisioningDescriptionException {
        return FeaturePackConfig.builder(fp2Gav).build();
    }
        ...
        return ProvisionedState.builder()
                .addFeaturePack(ProvisionedFeaturePack.builder(fp1Gav)
                        .addPackage(ProvisionedPackage.builder("a")
                                ...
                                .build())
                        .build())
                .addFeaturePack(ProvisionedFeaturePack.builder(fp2Gav).build())
                .build();
    }
