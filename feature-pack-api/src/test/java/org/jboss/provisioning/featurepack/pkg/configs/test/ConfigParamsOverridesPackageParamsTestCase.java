 ...
 */
public class ConfigParamsOverridesPackageParamsTestCase extends PmInstallFeaturePackTestBase {
    ...
    protected void setupRepo(FeaturePackRepoManager repoManager) throws ProvisioningDescriptionException {
        ...
        .newFeaturePack(fp1Gav)
            .newPackage("a", true)
                ...
                .addParameter("p2", "two")
                .addConfig("config1")
                    .addParameter("p1", "config1.orig.p1")
                    .getPackage()
                .getFeaturePack()
            .getInstaller()
        .install();
    ...
    protected FeaturePackConfig featurePackConfig() throws ProvisioningDescriptionException {
        return FeaturePackConfig.builder(fp1Gav)
                .includePackage(PackageConfig.builder("a")
                        .addConfig(ParameterSet.forName("config1"))
                        .build())
                .build();
    }
