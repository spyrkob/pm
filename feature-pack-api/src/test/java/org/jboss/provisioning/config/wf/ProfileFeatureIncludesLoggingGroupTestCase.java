    ...
    protected void setupRepo(FeaturePackRepoManager repoManager) throws ProvisioningDescriptionException {
        ...
        .newFeaturePack(FP_GAV)
            ...
            .addSpec(FeatureSpec.builder("logger")
                    ...
                    .addRef(FeatureReferenceSpec.builder("logging").build())
                    .build())
            .addSpec(FeatureSpec.builder("logging")
                    .addParam(FeatureParameterSpec.createId("profile"))
                    .addParam(FeatureParameterSpec.create("extension", "org.jboss.as.logging"))
                    .addRef(FeatureReferenceSpec.builder("extension").mapParam("extension", "module").build())
            ...
            .addSpec(FeatureSpec.builder("server-group")
                    ...
                    .addRef(FeatureReferenceSpec.builder("socket-binding-group").mapParam("socket-binding-group", "name").build())
                    .addRef(FeatureReferenceSpec.create("profile"))
                    .build())
            .addSpec(FeatureSpec.builder("socket-binding")
                    ...
                    .addRef(FeatureReferenceSpec.builder("socket-binding-group").mapParam("socket-binding-group", "name").build())
                    .addRef(FeatureReferenceSpec.builder("interface").setNillable(true).mapParam("interface", "name").build())
                    .build())
