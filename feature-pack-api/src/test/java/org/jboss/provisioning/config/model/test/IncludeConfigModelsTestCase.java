 ...
 */
public class IncludeConfigModelsTestCase extends PmProvisionConfigTestBase {
        ...
        .newFeaturePack(FP_GAV)
            ...
            .addConfig(Config.builder().setName("config1").setModel("model1")
                    ...
                    .addFeature(new FeatureConfig().setSpecName("specA")
                            ...
                            .setParam("p1", "config1"))
                    .build())
            .addConfig(Config.builder().setName("config2").setModel("model1")
                    .setProperty("prop1", "c2m1")
                    .addFeature(new FeatureConfig().setSpecName("specA")
                            .setParam("name", "a1")
                            .setParam("p1", "config2"))
                    .build())
            .addConfig(Config.builder().setName("config1").setModel("model2")
