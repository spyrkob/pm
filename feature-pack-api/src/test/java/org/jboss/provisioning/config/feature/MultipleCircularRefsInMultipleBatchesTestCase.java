    ...
    protected void setupRepo(FeaturePackRepoManager repoManager) throws ProvisioningDescriptionException {
        ...
        .newFeaturePack(FP_GAV)
            .addSpec(FeatureSpec.builder("specA")
                    ...
                    .addRef(FeatureReferenceSpec.create("specI"))
                    .build())
            ...
            .addSpec(FeatureSpec.builder("specD")
                    ...
                    .addRef(FeatureReferenceSpec.create("specC"))
                    .addRef(FeatureReferenceSpec.create("specE"))
                    .build())
            .addSpec(FeatureSpec.builder("specE")
                    ...
                    .addRef(FeatureReferenceSpec.create("specF"))
                    .addRef(FeatureReferenceSpec.create("specJ"))
                    .build())
            .addSpec(FeatureSpec.builder("specF")
                    ...
                    .addRef(FeatureReferenceSpec.create("specD"))
                    .addRef(FeatureReferenceSpec.create("specG"))
                    .build())
            .addSpec(FeatureSpec.builder("specG")
                    .addParam(FeatureParameterSpec.createId("g"))
                    .addParam(FeatureParameterSpec.create("h"))
                    .addRef(FeatureReferenceSpec.create("specH"))
                    .build())
            ...
            .addSpec(FeatureSpec.builder("specI")
                    ...
                    .addRef(FeatureReferenceSpec.create("specG"))
                    .addRef(FeatureReferenceSpec.create("specK"))
                    .build())
            ...
            .addSpec(FeatureSpec.builder("specK")
                    ...
                    .addRef(FeatureReferenceSpec.create("specL"))
                    .build())
